...
public class Game extends Application
{
    ...
    int level = 1;
    //Level Images
    Image background = new Image("pics/diner.png");
    Image counter = new Image("pics/counter.png");
    Image endGame = new Image("pics/L.png");
    //Food Images
    Image milk = new Image("pics/melk.png");
    Image burger = new Image("pics/burg.png");
    Image muffin = new Image("pics/mufn.png");
    //Player Image
    Image image = new Image("pics/waiter.png");
    //Customer Images
    Image customerBird = new Image("pics/smellican.png");
    Image customerBlob = new Image("pics/amongusamongus.png");
    Image customerMachine = new Image("pics/lkeafujgesdlfkjegh.png");
    //Audio Files
    String musicFile = "pics/arson diner_1.m4a";
    Media sound = new Media(new File(musicFile).toURI().toString());
    MediaPlayer mediaPlayer = new MediaPlayer(sound);
    
    String musicFile2 = "pics/arson diner L.m4a";
